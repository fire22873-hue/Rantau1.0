 ...
 * @desc Apresentar o cursor padrão.
 * @default true
 *
 * @param X-Axis Offset
...
　　var Moghunter = Moghunter || {}; 
  ...
  　 Moghunter.parameters = PluginManager.parameters('MOG_DestinationPointer');
    Moghunter.destCursor_ShowDefaultCursor = String(Moghunter.parameters['Show Default Cursor'] || 'true');
...
Spriteset_Map.prototype.createDestination = function() {
	var defcursor = String(Moghunter.destCursor_ShowDefaultCursor) == "true" ? true : false;
    if (defcursor) {
	    this._destinationSprite = new Sprite_Destination();
        this._destinationSprite.z = 9;
        this._tilemap.addChild(this._destinationSprite);	
	};
    this._destinationSprite2 = new Sprite_DestinationPointer();
